...
export function VoteButtons({
  ...
  if (compact) {
    // Compact version for cards - upvote and downvote with counts
    return (
      <div className="flex items-center gap-2">
        ...
        >
          ...
          <span className="text-sm font-bold">{downvoteCount}</span>
        </button>
      </div>
    )
  }

  // Full version for detail modal - both upvote and downvote with counts
  return (
    <div className="flex items-center gap-2">
      <button
        onClick={handleUpvote}
