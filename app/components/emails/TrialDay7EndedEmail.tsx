...
interface TrialDay7EndedEmailProps {
...
export const TrialDay7EndedEmail = ({
  firstName,
  userId,
  baseUrl = 'https://productcareerlyst.com',
  unsubscribeUrl,
}: TrialDay7EndedEmailProps) => {
            ...
            >
              ...
              <tr>
                <td className="content-padding" style={{ padding: '32px 24px' }}>
                  ...
                  >
                    Your trial has ended, but your career journey doesn't have to. You've started building 
                    momentum—here's what you can unlock when you return.
                  </p>
                  ...
                  >
                    ...
                    >
                      With Accelerate, you get unlimited access to:
                    </p>
                    <ul
                      style={{
                        color: '#374151',
                    ...
                    >
                      <li style={{ marginBottom: '12px' }}>
                        All courses and lessons—keep building skills
                      </li>
                      <li style={{ marginBottom: '12px' }}>
                  ...
                  >
                    You're closer than you think to your next role. Upgrade now and pick up right where you left off.
                  </p>
