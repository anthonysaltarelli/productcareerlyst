...
const BASELINE_ACTIONS: BaselineAction[] = [
  ...
  {
    actionId: 'interview-prep-recruiter-screen',
    label: 'Practice recruiter screen interviews',
    route: '/dashboard/interview',
    triggerLogic: 'Triggered when user logs a recruiter_screen practice interview via POST /api/practice-interviews. Calls markBaselineActionsComplete(userId, "recruiter_screen_prep_completed").',
    userExplanation: 'Log a practice recruiter screen interview in the Interview Prep section.',
    verified: true,
  },
  {
    actionId: 'interview-prep-hiring-manager',
    label: 'Practice hiring manager interviews',
    route: '/dashboard/interview',
    triggerLogic: 'Triggered when user logs a hiring_manager_screen practice interview via POST /api/practice-interviews. Calls markBaselineActionsComplete(userId, "hiring_manager_prep_completed").',
    userExplanation: 'Log a practice hiring manager interview in the Interview Prep section.',
    verified: true,
  },
  {
    actionId: 'interview-prep-product-sense',
    label: 'Practice product sense interviews',
    route: '/dashboard/interview',
    triggerLogic: 'Triggered when user logs a product_sense practice interview via POST /api/practice-interviews. Calls markBaselineActionsComplete(userId, "product_sense_prep_completed").',
    userExplanation: 'Log a practice product sense interview in the Interview Prep section.',
    verified: true,
  },
  {
    actionId: 'interview-prep-product-design',
    label: 'Practice product design interviews',
    route: '/dashboard/interview',
    triggerLogic: 'Triggered when user logs a product design practice interview via POST /api/practice-interviews. Calls markBaselineActionsComplete(userId, "product_design_prep_completed").',
    userExplanation: 'Log a practice product design interview in the Interview Prep section.',
    verified: true,
  },
  {
    actionId: 'interview-prep-analytics',
    label: 'Practice analytics/execution interviews',
    route: '/dashboard/interview',
    triggerLogic: 'Triggered when user logs a product_analytics_execution practice interview via POST /api/practice-interviews. Calls markBaselineActionsComplete(userId, "analytics_prep_completed").',
    userExplanation: 'Log a practice analytics/execution interview in the Interview Prep section.',
    verified: true,
  },
  {
    actionId: 'interview-prep-system-design',
    label: 'Practice system design interviews',
    route: '/dashboard/interview',
    triggerLogic: 'Triggered when user logs a system_design practice interview via POST /api/practice-interviews. Calls markBaselineActionsComplete(userId, "system_design_prep_completed").',
    userExplanation: 'Log a practice system design interview in the Interview Prep section.',
    verified: true,
  },
  {
    actionId: 'interview-prep-technical',
    label: 'Practice technical interviews',
    route: '/dashboard/interview',
    triggerLogic: 'Triggered when user logs a technical practice interview via POST /api/practice-interviews. Calls markBaselineActionsComplete(userId, "technical_prep_completed").',
    userExplanation: 'Log a practice technical interview in the Interview Prep section.',
    verified: true,
  },
  {
    actionId: 'interview-prep-strategy',
    label: 'Practice product strategy interviews',
    route: '/dashboard/interview',
    triggerLogic: 'Triggered when user logs a product_strategy practice interview via POST /api/practice-interviews. Calls markBaselineActionsComplete(userId, "strategy_prep_completed").',
    userExplanation: 'Log a practice product strategy interview in the Interview Prep section.',
    verified: true,
  },
  {
    actionId: 'interview-prep-estimation',
    label: 'Practice estimation interviews',
    route: '/dashboard/interview',
    triggerLogic: 'Triggered when user logs an estimation practice interview via POST /api/practice-interviews. Calls markBaselineActionsComplete(userId, "estimation_prep_completed").',
    userExplanation: 'Log a practice estimation interview in the Interview Prep section.',
    verified: true,
  },
  {
    actionId: 'interview-prep-executive',
    label: 'Practice executive interviews',
    route: '/dashboard/interview',
    triggerLogic: 'Triggered when user logs an executive practice interview via POST /api/practice-interviews. Calls markBaselineActionsComplete(userId, "executive_prep_completed").',
    userExplanation: 'Log a practice executive interview in the Interview Prep section.',
    verified: true,
  },
  {
    actionId: 'interview-prep-cross-functional',
    label: 'Practice cross-functional interviews',
    route: '/dashboard/interview',
    triggerLogic: 'Triggered when user logs a cross_functional practice interview via POST /api/practice-interviews. Calls markBaselineActionsComplete(userId, "cross_functional_prep_completed").',
    userExplanation: 'Log a practice cross-functional interview in the Interview Prep section.',
    verified: true,
  },
  {
    actionId: 'interview-prep-behavioral',
    label: 'Practice behavioral interviews',
    route: '/dashboard/interview',
    triggerLogic: 'Triggered when user clicks "My 8 Stories" resource on PM Templates page OR logs a behavioral practice interview. Calls markBaselineActionsComplete(userId, "behavioral_prep_completed").',
    userExplanation: 'Log a practice behavioral interview in the Interview Prep section, or complete the My 8 Stories worksheet.',
    verified: true,
  },
  {
    actionId: 'interview-practice-mock',
    label: 'Complete a general mock interview',
    route: '/dashboard/interview',
    triggerLogic: 'Triggered when mock interview is completed via POST /api/practice-interviews. Calls markBaselineActionsComplete(userId, "mock_interview_completed").',
    userExplanation: 'Log a mock interview session in the Interview Prep section.',
    verified: true,
  },
  {
...
const WEEKLY_GOALS: WeeklyGoal[] = [
  ...
  },
  {
    ...
    route: '/dashboard/jobs/contacts/[contactId]',
    triggerLogic: 'Incremented when networking call is scheduled via POST /api/jobs/contacts/[id]/scheduled-calls. Calls incrementWeeklyGoalProgress(userId, "networking_call_scheduled").',
    userExplanation: 'Schedule and log networking calls with industry contacts from the Contact Details page.',
    verified: true,
  },
  {
    ...
    route: '/dashboard/jobs/contacts/[contactId]',
    triggerLogic: 'Incremented when outreach is logged via POST /api/jobs/contacts/[id]/outreach. Calls incrementWeeklyGoalProgress(userId, "outreach_email_sent").',
    userExplanation: 'Log your outreach emails, LinkedIn messages, and other contacts from the Contact Details page.',
    verified: true,
  },
  {
    ...
    route: '/dashboard/interview',
    triggerLogic: 'Incremented when a practice interview is logged via POST /api/practice-interviews. Calls incrementWeeklyGoalProgress(userId, "interview_practice_completed").',
    userExplanation: 'Log practice interviews in the Interview Prep section to track your interview practice sessions.',
    verified: true,
  },
  {
    ...
    route: '/dashboard/jobs',
    triggerLogic: 'Incremented when POST /api/jobs/companies/[id]/research generates new research (single or batch). Calls incrementWeeklyGoalProgress(userId, "company_researched"). Note: GET requests (viewing existing research) do NOT increment weekly goals.',
  ...
  },
  {
    ...
    triggerLogic: 'Incremented when a course lesson is completed via POST /api/lessons/[lessonId]/progress. Only increments for new completions (not re-completions). Calls incrementWeeklyGoalProgress(userId, "lesson_completed").',
