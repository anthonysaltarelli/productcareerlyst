...
const BASELINE_ACTIONS: BaselineAction[] = [
  ...
  {
    actionId: 'resume-score-70',
    label: 'Reach a 70+ resume score',
    route: '/dashboard/resume',
    triggerLogic: 'Triggered when resume analysis returns overallScore >= 70. Calls markBaselineActionsComplete(userId, "resume_score_70").',
    userExplanation: 'Improve your resume based on AI recommendations until your score reaches 70 or higher.',
    verified: false,
  },
  {
    actionId: 'resume-score-80',
    label: 'Reach an 80+ resume score',
    route: '/dashboard/resume',
    triggerLogic: 'Triggered when resume analysis returns overallScore >= 80. Calls markBaselineActionsComplete(userId, "resume_score_80").',
    userExplanation: 'Continue optimizing your resume until your score reaches 80 or higher.',
    verified: false,
  },
  {
  ...
  },
  {
    ...
    route: '/dashboard/resume',
    triggerLogic: 'Triggered when POST /api/resume/export-pdf completes. Calls markBaselineActionsComplete(userId, "resume_exported"). NOTE: Not yet implemented - endpoint lacks auth context.',
  ...
  },
  {
    ...
    route: '/dashboard/portfolio/editor',
    triggerLogic: 'Triggered when first case study is published. Calls markBaselineActionsComplete(userId, "portfolio_first_case_added"). NOTE: Trigger not yet implemented.',
  ...
  },
  {
    ...
    route: '/dashboard/portfolio/editor',
    triggerLogic: 'Triggered when second case study is published. Calls markBaselineActionsComplete(userId, "portfolio_second_case_added"). NOTE: Trigger not yet implemented.',
  ...
  },
  {
    ...
    route: '/dashboard/portfolio',
    triggerLogic: 'Triggered when portfolio visibility is set to public. Calls markBaselineActionsComplete(userId, "portfolio_published"). NOTE: Trigger not yet implemented.',
  ...
  // Course actions
  {
    ...
    triggerLogic: 'Triggered when course completion is recorded. Calls markBaselineActionsComplete(userId, "course_resume_linkedin_completed"). NOTE: Trigger not yet implemented.',
  ...
  },
  {
    ...
    triggerLogic: 'Triggered when course completion is recorded. Calls markBaselineActionsComplete(userId, "course_portfolio_completed"). NOTE: Trigger not yet implemented.',
  ...
  },
  {
    ...
    triggerLogic: 'Triggered when course completion is recorded. Calls markBaselineActionsComplete(userId, "course_secure_referral_completed"). NOTE: Trigger not yet implemented.',
  ...
  },
  {
    ...
    triggerLogic: 'Triggered when course completion is recorded. Calls markBaselineActionsComplete(userId, "course_company_prep_completed"). NOTE: Trigger not yet implemented.',
  ...
  },
  {
    ...
    triggerLogic: 'Triggered when course completion is recorded. Calls markBaselineActionsComplete(userId, "course_pm_interviews_completed"). NOTE: Trigger not yet implemented.',
  ...
  },
  {
    ...
    triggerLogic: 'Triggered when course completion is recorded. Calls markBaselineActionsComplete(userId, "course_negotiation_completed"). NOTE: Trigger not yet implemented.',
  ...
  },
  {
    ...
    triggerLogic: 'Triggered when course completion is recorded. Calls markBaselineActionsComplete(userId, "course_pm_fundamentals_completed"). NOTE: Trigger not yet implemented.',
  ...
  // Job search actions
  {
    ...
    triggerLogic: 'Triggered when POST /api/jobs/applications creates a new application. Calls markBaselineActionsComplete(userId, "job_added").',
  ...
  },
  {
    ...
    route: '/dashboard/jobs',
    triggerLogic: 'Triggered when target companies are added. Calls markBaselineActionsComplete(userId, "target_companies_added"). NOTE: Trigger not yet implemented.',
  ...
  },
  {
    ...
    triggerLogic: 'Triggered when networking scripts are accessed. Calls markBaselineActionsComplete(userId, "networking_scripts_accessed"). NOTE: Trigger not yet implemented.',
  ...
  // Interview prep actions
  {
    ...
    triggerLogic: 'Triggered when behavioral prep is completed. Calls markBaselineActionsComplete(userId, "behavioral_prep_completed"). NOTE: Trigger not yet implemented.',
  ...
  // Resource actions
  {
    ...
    route: '/dashboard/templates',
    triggerLogic: 'Triggered when resume guide is accessed. Calls markBaselineActionsComplete(userId, "resume_guide_accessed"). NOTE: Trigger not yet implemented.',
  ...
  },
  {
    ...
    route: '/dashboard/templates',
    triggerLogic: 'Triggered when interview frameworks are accessed. Calls markBaselineActionsComplete(userId, "interview_frameworks_accessed"). NOTE: Trigger not yet implemented.',
  ...
  },
  {
    ...
    route: '/dashboard/templates',
    triggerLogic: 'Triggered when negotiation scripts are accessed. Calls markBaselineActionsComplete(userId, "negotiation_scripts_accessed"). NOTE: Trigger not yet implemented.',
  ...
  },
  {
    ...
    route: '/dashboard/templates',
    triggerLogic: 'Triggered when PRD template is accessed. Calls markBaselineActionsComplete(userId, "prd_template_accessed"). NOTE: Trigger not yet implemented.',
