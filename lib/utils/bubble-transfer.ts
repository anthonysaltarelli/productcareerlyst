...
/**
 * Transfer Bubble subscription to a new Supabase user
 * Call this after user signup (email confirmation or OAuth callback)
 */
export const transferBubbleSubscription = async (userId: string, email: string): Promise<void> => {
